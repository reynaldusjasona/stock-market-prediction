...
class TestUC11LandingPage:
    def test_A_11_BB_headline_persists(self):
        ...
        with patch("app.routers.admin.updateLandingContent", return_value=content), \
    ...
    def test_A_11_WB_raw_object_not_wrapped(self):
        payload = {"hero": {"headline": "test"}, "about": {}, "features": {}, "testimonials": [], "subscription": {}, "faqs": []}
        with patch("app.routers.admin.updateLandingContent", return_value=payload) as mock_upd, \
             patch("app.routers.admin.logActivity", return_value=None):
    ...
    def test_A_11_FN_all_six_sections_saved(self):
        full_content = {"hero": {}, "about": {}, "features": {}, "testimonials": [], "subscription": {}, "faqs": []}
        with patch("app.routers.admin.updateLandingContent", return_value=full_content), \
             patch("app.routers.admin.logActivity", return_value=None), \
        ...
        assert all(k in r.json() for k in ["hero", "about", "features", "testimonials", "subscription", "faqs"])
