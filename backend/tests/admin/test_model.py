...
class TestUC12ModelPerformance:
    ...
    def test_A_12_FN_consistent_with_dashboard(self):
        ...
        with patch("app.routers.admin.getModelPerformance", return_value=perf), patch(
            "app.routers.admin.getDashboardStats", return_value=stats
        ):
...
class TestUC13PredictionQuality:
    def test_A_13_BB_two_class_chart_data(self):
        shaped = {
            "classes": [
                {"class_name": "Buy", "precision": 0.7, "recall": 0, "f1_score": 0, "support": 0},
...
class TestUC14Retrain:
    def test_A_14_BB_invalid_date_range_rejected(self):
        ...
        with patch(
            "app.routers.admin.requestModelRetrain", side_effect=ValueError("Start after end")
        ):
    ...
    def test_A_14_WB_payload_contains_job_id_on_success(self):
        with patch(
            "app.routers.admin.requestModelRetrain",
            return_value={
    ...
    def test_A_14_FN_submit_then_poll_status(self):
        with patch(
            ...
            "app.routers.admin.getRetrainStatus", return_value={"status": "completed"}
        ):
