...
export function requireAdmin() {
  if (!sessionStorage.getItem('sw_token'))              { window.location.href='/admin/login'; return false }
  if (sessionStorage.getItem('sw_role') !== 'admin')   { window.location.href='/dashboard';   return false }
  return true
}
